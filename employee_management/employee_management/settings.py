...
MIDDLEWARE = [
    ...
    'employees.middleware.login_required_middleware',
    'employees.middleware.redirect_on_404',
]
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Если файлы статики находятся в папке 'static'
